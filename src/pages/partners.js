...
const Partners = () => {
  return (
    <BaseLayout>
      <SEO
        title="Our Partners"
        description={`At Starter Storm, we partner with a few select servers in a related industry in an effort to share resources and connect people together. Our current partner count is ${partners.length}.`}
      />
